...
ggplot(data=stock_data_tbl,aes(x=date,y=adjusted,color=symbols))+
  geom_line()+xlab('Date')+ylab('Adjusted price')+theme_bw()+scale_colour_manual(values=c("red","green","blue","pink"))
